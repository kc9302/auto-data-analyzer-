...
class FeatureMetadataCatalog:
    ...
    def get_info(self, feature_name: str) -> Dict[str, str]:
        ...
        if clean_name.startswith("C_"):
            return {
                "feature_name": clean_name,
                "korean_name": clean_name,
                "origin_type": "합성 · 학생×아이템 교차 신호",
                "source_mart": "파생(교차) (기반: EDUMART.DM_STUDENT_COURSE_HIST x DM_COURSE_INFO)",
            ...
            return {
                ...
                "source_mart": "EDUMART.DM_COURSE_INFO / EDUMART.V_COURSE_ITEMS",
            ...
            return {
                ...
                "source_mart": "EDUMART.DM_STUDENT_INFO / EDUMART.V_STUDENT_USERS",
                "signal_group": "학생 프로필",
